...
def generate_launch_description():
    ...
    # Config files
    traj_cfg = os.path.join(cfg_dir, 'trajectory_parameters_ur3.yaml')
    robot_cfg = os.path.join(cfg_dir, 'robot_parameters_ur3.yaml')
    mocap_cfg = os.path.join(cfg_dir, 'human_reach_TUM_lab.yaml')
    params = os.path.join(cfg_dir, 'safety_shield_params_ur3.yaml')
    rviz_cfg = os.path.join(rviz_dir, 'ur3.rviz')
